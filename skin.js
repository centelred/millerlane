...
// Pano2VR 5.2.3/15990
// Filename: silhouettelrealty.ggsk
// Generated Tue Jan 23 19:47:52 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs ='';
		hs+='background : rgba(30,70,116,0.784314);';
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_node') {
			...
			hs ='';
			hs+='background : rgba(30,70,116,0.666667);';
			hs+='border : 1px solid #c2c2c2;';
			hs+='cursor : default;';
			hs+='height : 114px;';
			hs+='left : 0px;';
			hs+='position : absolute;';
		...
		if (hotspot.skinid=='ht_info') {
			...
			this._ht_info_image.onmousedown=function (e) {
				me._ht_info_image__imga.style.visibility='inherit';
				me._ht_info_image__imgo.style.visibility='hidden';
			}
			this._ht_info_image.onmouseup=function (e) {
				me._ht_info_image__imga.style.visibility='hidden';
				me._ht_info_image__imgo.style.visibility='inherit';
			}
